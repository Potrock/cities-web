				...
				<div className="items-center px-4 py-8 mx-auto mt-4 sm:mt-6 sm:px-8 md:px-12">
					<div className="relative px-4 md:px-24">
						...
						<div className="py-6 md:py-12 space-y-[1rem]">
							...
							<div className="md:text-center lg:text-center md:block lg:block">
								<p>
									Fully decentralized on chain crypto strategy
									game.
								</p>
								<p>
									Claim your city. Build upgrades. All
						...
						<div className="grid sm:grid-cols-1 md:grid-cols-3 gap-12 py-6 mx-auto mb-12 md:py-12 2xl:w-3/4">
							<div className="space-y-4">
								...
								<div>
									Mint your city. Unlock the full power of
									ERC721 compliant NFTs and integrate with
									other platforms.
								</div>
							</div>
							<div className="space-y-4">
								...
								<div>
									Build farms, barracks, and more. Harvest
									food, train troops, and upgrade buildings to
									boost production.
								</div>
							</div>
							<div className="space-y-4">
								...
								<div>
									You, and only you, own your city. Trade it,
									sell it, hodl it. All stats, and actions are
									completely on-chain and non-custodial.
								</div>
							</div>
						</div>
					</div>
					<div className="">
						...
						<div className="justify-center flex">
							<Link href="https://github.com/Potrock/Crypto-Cities">
								<button className="btn btn-md btn-accent">
									Contract Code
								</button>
							</Link>
						</div>
